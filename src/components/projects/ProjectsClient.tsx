...
export default function ProjectsClient({
  ...
  return (
    <>
      <CategoryFilter activeCategory={activeCategory} />
      <section className="px-8 pb-20 pt-8 md:px-10 md:pb-24 md:pt-10 bigcards:px-16 2xl:px-20">
        <div className="mx-auto max-w-[1140px] bigcards:max-w-none 2xl:max-w-none">
                ...
                <Link href={`/projects/${project.slug}`} className="group block">
                  <div className="overflow-hidden bg-transparent">
                    <ResponsiveProjectImage
                      ...
                      className="mx-auto block h-auto w-auto max-h-[58vh] max-w-full object-contain transition duration-700 group-hover:scale-[1.015] tall:max-h-none tall:w-full bigcards:max-h-none bigcards:w-full 3xl:max-h-[72vh]"
                    />
                  </div>
