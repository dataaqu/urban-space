        ...
        >
          ...
          <motion.div variants={staggerItem}>
            ...
            <ul className="space-y-3">
              {[
                ...
                { href: '/projects?category=ARCHITECTURE', label: navT('architecture') },
                { href: '/projects?category=URBAN', label: navT('urban') },
              ].map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
          ...
          <motion.div variants={staggerItem}>
            ...
            <div className="mt-6 pt-6 border-t border-white/5 space-y-3 text-secondary-400 text-sm">
              <a href="mailto:info@urbanspace.ge" className="flex items-center gap-3 group hover:text-primary-400 transition-colors duration-300">
              ...
              <a href="tel:+995XXXXXXXXX" className="flex items-center gap-3 group hover:text-primary-400 transition-colors duration-300">
                <span className="w-8 h-8 flex items-center justify-center rounded-lg bg-white/5 group-hover:bg-primary-500/20 transition-colors duration-300">
                  <svg className="w-4 h-4 text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
