...
export default function VideoUpload({ value, onChange, onRemove, folder = 'urban-space' }: VideoUploadProps) {
    ...
    <div>
      {value ? (
        <div className="relative group rounded-lg overflow-hidden border border-gray-200">
          <video src={value} className="w-full h-48 object-cover" muted />
        ...
        >
          {uploading ? (
            ...
            <div className="text-secondary-400">
              ...
              <p className="text-sm">ჩააგდეთ ვიდეო ან დააკლიკეთ</p>
            </div>
          )}
        </div>
      )}
