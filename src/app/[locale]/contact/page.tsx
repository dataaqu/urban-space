      ...
      <div className="px-8 md:px-[60px] lg:px-[80px] py-16 lg:py-20">
        <div className="flex flex-col-reverse lg:flex-row">
          ...
          <div className="w-full lg:w-[50%] flex-shrink-0 mt-12 lg:mt-0">
            ...
            {/* Info Section */}
            <div className="mb-10">
              <h3 className="text-[13px] font-medium tracking-[0.2em] uppercase text-[#444] mb-2">
                {infoLabel}
              </h3>
              <div className="w-8 h-[2px] bg-[#999] mb-8" />
              <div className="space-y-7">
                <div className="flex items-center gap-4">
                  <svg className="w-[22px] h-[22px] text-[#777] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.3}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                  </svg>
                  <span className="text-[17px] text-[#333]">{address}</span>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a href={`mailto:${email}`} className="text-[17px] text-[#333] hover:text-black transition-colors">
                    {email}
                  </a>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a href={`tel:${phone}`} className="text-[17px] text-[#333] hover:text-black transition-colors">
                    {phone}
                  </a>
                </div>
              </div>
            ...
            <div className="pt-8 mb-10">
              ...
              <div className="flex items-center gap-8">
                <a href={facebookUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 text-[#555] hover:text-black transition-colors">
                ...
                <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 text-[#555] hover:text-black transition-colors">
                ...
                <a href={linkedinUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 text-[#555] hover:text-black transition-colors">
            ...
            <div className="pt-8">
              ...
              <div className="w-8 h-[2px] bg-[#999] mb-6" />
              <p className="text-[17px] text-[#333]">{officeAddress}</p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-[40%] flex flex-col">
            <div className="mb-4">
              <p className="text-[15px] font-semibold text-[#0A0A0A]">URBAN SPACE</p>
            ...
            <div className="flex items-center justify-between mt-3">
              ...
              <a
                ...
                className="text-[12px] text-[#666] underline hover:text-black transition-colors"
              >
                View on Google Maps
              </a>
            </div>
